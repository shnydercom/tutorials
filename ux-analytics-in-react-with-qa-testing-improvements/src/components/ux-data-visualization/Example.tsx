...
const purple1 = "#6c5efbaa";
const purple2 = "#c998ffaa";
export const purple3 = "#a44afeaa";
export const background = "#eaedffaa";
...
const data = cityTemperature
  .slice(0, 12)
  .concat(cityTemperature.slice(0, 12).map((val) => ({ ...val, Austin: `${parseFloat(val.Austin)*2}` })));
...
/**
 * based on: https://airbnb.io/visx/barstackhorizontal
 * */

  ...
  return (
    <div className="intro-page">
      <div className="how-to">
        ...
        <b>adding custom attributes</b>. It's independent of the library, be it
        jest, puppeteer, cypress, selenium or others, because it works with html
        attributes. In HTML5, you can add custom attributes, and testing
        ...
        <p>
          Even if you're not doing browser-based testing yet, by including these
          attributes you'll make life easier for a future tester-colleague. In
          the meantime you'll have a couple of reusable functions for learning
          more about your users.
        </p>
        <p>
          Try scrolling through <Link to="/userpage">the user's page</Link>, and
          see the events on <Link to="/analytics">the analytics page</Link>{" "}
          afterwards.
        </p>
      </div>
    </div>

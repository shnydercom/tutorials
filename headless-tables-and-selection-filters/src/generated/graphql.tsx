 ...
 * });
 */
export function useGetAllHerosQuery(baseOptions?: Apollo.QueryHookOptions<GetAllHerosQuery, GetAllHerosQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllHerosQuery, GetAllHerosQueryVariables>(GetAllHerosDocument, options);
      }
export function useGetAllHerosLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllHerosQuery, GetAllHerosQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllHerosQuery, GetAllHerosQueryVariables>(GetAllHerosDocument, options);
        }
export type GetAllHerosQueryHookResult = ReturnType<typeof useGetAllHerosQuery>;
export type GetAllHerosLazyQueryHookResult = ReturnType<typeof useGetAllHerosLazyQuery>;
export type GetAllHerosQueryResult = Apollo.QueryResult<GetAllHerosQuery, GetAllHerosQueryVariables>;